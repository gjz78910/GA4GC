...
# Handle resource module for Windows compatibility
...
def filter_dataset_to_build(
    ...
    Args:
        dataset (list): List of instances (usually all of dev/test split)
    ...
    for instance in dataset:
        if instance_ids and instance[KEY_INSTANCE_ID] not in instance_ids:
